...
class MailboxMemoryStore(Protocol):
    ...
    def mutate_case(self, case_id: str, mutator: Any, *, create_if_missing: bool = False) -> dict[str, Any]: ...
    ...
    # Durable owner for the canonical decision revision lineage. The
    # DecisionRevisionLedger is a projection/cache over these rows; after a
    # process restart it rebuilds from this store and fails closed on any
    # one-current invariant violation.
