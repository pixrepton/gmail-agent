...
This project is indexed by GitNexus as **gmail-agent** (17147 symbols, 44964 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
