...
This project is indexed by GitNexus as **gmail-agent** (15097 symbols, 38003 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
