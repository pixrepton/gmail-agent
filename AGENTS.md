...
This project is indexed by GitNexus as **gmail-agent** (17344 symbols, 45459 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
